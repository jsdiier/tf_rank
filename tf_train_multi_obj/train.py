        ...
        for epo in range(epoch_num):
            ...
            for step, feat in enumerate(train_data):
                with tf.GradientTape() as tape:
                    ...
                    pred_buy, pred_cat, pred_click, pred_ext, gate1, gate2, gate3, gate4, fusion_score = model([feat['sids'], feat['fids']])
                    ...
                    floss =  fusion_Loss(fusion_score, feat, 0.15, 0.0, 1.0, 0.0)

                    final_loss = loss_buy * buy_weight + loss_cat * cat_weight + loss_click * click_weight + loss_ext * ext_weight + floss
